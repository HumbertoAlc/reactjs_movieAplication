...
fill:"#fff","fill-rule":"nonzero"}}]}]}]},e="Abrir p\u00e1gina del video";a.O().ea("kevlar_miniplayer_expand_top")&&(c="ytp-miniplayer-button-top-left",d={D:"svg",P:{height:"24px",version:"1.1",viewBox:"0 0 24 24",width:"24px"},K:[{D:"g",P:{fill:"none","fill-rule":"evenodd",stroke:"none","stroke-width":"1"},K:[{D:"g",P:{transform:"translate(12.000000, 12.000000) scale(-1, 1) translate(-12.000000, -12.000000) "},K:[{D:"path",P:{d:"M19,19 L5,19 L5,5 L12,5 L12,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,12 L19,12 L19,19 Z M14,3 L14,5 L17.59,5 L7.76,14.83 L9.17,16.24 L19,6.41 L19,10 L21,10 L21,3 L14,3 Z",
fill:"#fff","fill-rule":"nonzero"}}]}]}]},e="Expandir");g.U.call(this,{D:"button",ca:["ytp-miniplayer-expand-watch-page-button","ytp-button",c],P:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button"},K:[d]});this.H=a;this.ma("click",this.onClick,this);this.la("title",g.oP(a,e,"i"));g.Te(this,g.bQ(b.wb(),this.element))},P5=function(a){g.U.call(this,{D:"div",
J:"ytp-miniplayer-ui"});this.il=!1;this.player=a;this.L(a,"minimized",this.Eh);this.L(a,"onStateChange",this.KO)},Q5=function(a){g.iO.call(this,a);
...
g.k.show=function(){this.Fc=new g.Un(this.Nn,null,this);this.Fc.start();if(!this.il){this.tooltip=new g.xS(this.player,this);g.C(this,this.tooltip);g.VN(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.tb=new g.VP(this.player);g.C(this,this.tb);this.Si=new g.U({D:"div",J:"ytp-miniplayer-scrim"});g.C(this,this.Si);this.Si.aa(this.element);this.L(this.Si.element,"click",this.AC);var a=new g.U({D:"button",ca:["ytp-miniplayer-close-button","ytp-button"],P:{"aria-label":"Cerrar"},K:[g.MO()]});
g.C(this,a);a.aa(this.Si.element);this.L(a.element,"click",this.El);a=new O5(this.player,this);g.C(this,a);a.aa(this.Si.element);this.lj=new g.U({D:"div",J:"ytp-miniplayer-controls"});g.C(this,this.lj);this.lj.aa(this.Si.element);this.L(this.lj.element,"click",this.AC);var b=new g.U({D:"div",J:"ytp-miniplayer-button-container"});g.C(this,b);b.aa(this.lj.element);a=new g.U({D:"div",J:"ytp-miniplayer-play-button-container"});g.C(this,a);a.aa(this.lj.element);var c=new g.U({D:"div",J:"ytp-miniplayer-button-container"});
g.C(this,c);c.aa(this.lj.element);this.VC=new g.xR(this.player,this,!1);g.C(this,this.VC);this.VC.aa(b.element);b=new g.vR(this.player,this);g.C(this,b);b.aa(a.element);this.nextButton=new g.xR(this.player,this,!0);g.C(this,this.nextButton);this.nextButton.aa(c.element);this.gg=new g.mS(this.player,this);g.C(this,this.gg);this.gg.aa(this.Si.element);this.dc=new g.BR(this.player,this);g.C(this,this.dc);g.VN(this.player,this.dc.element,4);this.Gq=new g.U({D:"div",J:"ytp-miniplayer-buttons"});g.C(this,
this.Gq);g.VN(this.player,this.Gq.element,4);a=new g.U({D:"button",ca:["ytp-miniplayer-close-button","ytp-button"],P:{"aria-label":"Cerrar"},K:[g.MO()]});g.C(this,a);a.aa(this.Gq.element);this.L(a.element,"click",this.El);a=new g.U({D:"button",ca:["ytp-miniplayer-replay-button","ytp-button"],P:{"aria-label":"Cerrar"},K:[g.ZO()]});g.C(this,a);a.aa(this.Gq.element);this.L(a.element,"click",this.JM);this.L(this.player,"presentingplayerstatechange",this.Eb);this.L(this.player,"appresize",this.Oa);this.L(this.player,
...
g.k.JM=function(){this.player.playVideo()};
g.k.AC=function(a){if(a.target===this.Si.element||a.target===this.lj.element)g.R(this.player.O().experiments,"kevlar_miniplayer_play_pause_on_scrim")?g.NH(g.fE(this.player))?this.player.pauseVideo():this.player.playVideo():this.player.oa("onExpandMiniplayer")};
...
g.k.Nn=function(){this.Xc();this.Fc&&this.Fc.start()};
g.k.Eb=function(a){g.W(a.state,32)&&this.tooltip.hide()};
g.k.Oa=function(){this.dc.setPosition(0,g.EN(this.player).getPlayerSize().width,!1);this.dc.ix()};
g.k.KO=function(a){this.player.app.M.o&&(0===a?this.hide():this.show())};
